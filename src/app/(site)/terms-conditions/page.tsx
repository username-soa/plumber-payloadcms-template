...
export async function generateMetadata() {
	const page = await getPageData("terms-conditions");
	...
	const metaTitle =
		page.meta?.title || `Terms & Conditions | ${SITE_CONFIG.brand.name}`;
...
export default async function TermsConditionsPage() {
	const page = (await getPageData("terms-conditions")) as PayloadPage | null;
