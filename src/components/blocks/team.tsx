...
export function Team({ title, titleHighlight, description, selectedMembers }: Props) {
			...
			<div className="container mx-auto px-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{selectedMembers.map((member, index) => {
                        ...
                        const altText = typeof member.image === 'object' && member.image?.alt ? member.image.alt : member.name;
                                    ...
                                    {member.certifications && member.certifications.length > 0 && (
                                        <div className="flex flex-wrap gap-2">
                                            {member.certifications.map((certItem) => (
                                                <Badge key={certItem.id || certItem.certification} variant="secondary" className="text-xs">
